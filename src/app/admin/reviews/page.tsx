  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-end mb-8 gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-slate-900 mb-1">Reviews</h1>
          <p className="text-slate-500 text-sm">Moderate testimonials and customer review quality.</p>
        </div>
