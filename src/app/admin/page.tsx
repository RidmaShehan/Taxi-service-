        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="bg-[#f4f9ff] rounded-2xl border border-blue-50 p-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button className="bg-white p-3.5 rounded-xl border border-slate-100 flex flex-col items-center justify-center gap-2 text-xs font-semibold text-slate-700 hover:border-[#1e90ff] hover:text-[#1e90ff] transition-all shadow-sm">
