        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-4 md:p-6">
            <div className="flex justify-between items-center mb-6">
              <div>
                <h2 className="text-lg font-bold text-slate-900">Manual Booking Form</h2>
                <p className="text-xs text-slate-500 mt-1">Create a booking on behalf of a customer.</p>
              </div>
            ...
            <div className="overflow-x-auto -mx-4 md:mx-0 px-4 md:px-0">
              <div className="grid grid-cols-2 gap-4 min-w-[640px]">
                <div>
                  ...
                  <input className="mt-1 w-full rounded-lg border border-slate-200 px-3 py-2.5 text-sm" placeholder="John Doe" />
                </div>
                <div>
                  <label className="text-xs font-semibold text-slate-500">Phone</label>
                  <input className="mt-1 w-full rounded-lg border border-slate-200 px-3 py-2.5 text-sm" placeholder="+94 77 123 4567" />
                </div>
                <div>
                  <label className="text-xs font-semibold text-slate-500">Pickup</label>
                  <input className="mt-1 w-full rounded-lg border border-slate-200 px-3 py-2.5 text-sm" placeholder="Bandaranaike Airport" />
                </div>
                <div>
                  <label className="text-xs font-semibold text-slate-500">Destination</label>
                  <input className="mt-1 w-full rounded-lg border border-slate-200 px-3 py-2.5 text-sm" placeholder="Colombo 03" />
                </div>
                <div>
                  <label className="text-xs font-semibold text-slate-500">Date</label>
                  <input type="date" className="mt-1 w-full rounded-lg border border-slate-200 px-3 py-2.5 text-sm" />
                </div>
                <div>
                  <label className="text-xs font-semibold text-slate-500">Time</label>
                  <input type="time" className="mt-1 w-full rounded-lg border border-slate-200 px-3 py-2.5 text-sm" />
                </div>
              </div>
            </div>
          </div>
